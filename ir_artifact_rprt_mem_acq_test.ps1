...
###OLD###    
    ...
    $get_app_local = $appdata_local_array | Sort-Object -Property CreationTimeUtc | ConvertTo-Html -AS Table -Fragment -PreContent ‘<h3>User AppData Local Directory Info</h3>’ | Out-String
    $get_app_roam = $appdata_roam_array | Sort-Object -Property CreationTimeUtc | ConvertTo-Html -AS Table -Fragment -PreContent ‘<h3>User AppData Roaming Directory Info</h3>’ | Out-String
    $get_user_dld = $user_dld_array | Sort-Object -Property CreationTimeUtc | ConvertTo-Html -AS Table -Fragment -PreContent ‘<h3>User Downloads Directory Info</h3>’ | Out-String
    $get_user_dsk = $user_dsk_array | Sort-Object -Property CreationTimeUtc | ConvertTo-Html -AS Table -Fragment -PreContent ‘<h3>User Desktop Directory Info</h3>’ | Out-String
    $get_user_doc = $user_doc_array | Sort-Object -Property CreationTimeUtc | ConvertTo-Html -AS Table -Fragment -PreContent ‘<h3>User Documents Directory Info</h3>’ | Out-String
    $get_user_chrm = $user_chrm_brwsr_array | Sort-Object -Property CreationTimeUtc | ConvertTo-Html -AS Table -Fragment -PreContent ‘<h3>User Chrome Browser Info</h3>’ | Out-String
    $get_user_ff = $user_ff_brwsr_array | Sort-Object -Property CreationTimeUtc | ConvertTo-Html -AS Table -Fragment -PreContent ‘<h3>User FireFox Browser Info</h3>’ | Out-String
    #NEW
    ...
    #NEW
    $post_output = @($get_auto_run, $get_hku_autorun, $get_progdata_strt, $get_pref, $get_sys_temp, $get_hku_url, $get_user_ff, $get_user_chrm, $get_app_local, $get_app_roam, $get_user_dld, $get_user_dsk, $get_user_doc)
    #NEW
